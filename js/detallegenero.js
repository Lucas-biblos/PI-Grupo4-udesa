...
.then(function(data) {
    ...
    for (let i = 0; i < miData.length; i++){
        contenido += `<li> <a href="./pelicula.html?id=${miData[i].id}"><img class="Fotos-seriepopular" src="https://image.tmdb.org/t/p/w200${miData[i].poster_path}" alt="${miData[i].title}"></a>
